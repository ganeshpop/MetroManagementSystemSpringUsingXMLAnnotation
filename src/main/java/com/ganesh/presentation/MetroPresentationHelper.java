...
public class MetroPresentationHelper {
    ...
    public static void displayTransactions(Collection<Transaction> transactions, boolean isSwipeOut){
            ...
            if (transactions.size() == 0) {
                ...
                for (Transaction transaction : transactions) {
                    ...
                    transactionString.append(Color.ANSI_MAGENTA + "-------------- Trip ").append(transaction.getTransactionId()).append(" Details --------------")
    ...
    public static void displayCardDetails(Card card) {
        ...
        if (card == null) {
            ...
            String cardString = Color.ANSI_GREEN + "-------------- Card " + card.getCardId() + " Details --------------" + Color.ANSI_RESET +
    ...
    public static void displayStations(Collection<Station> stations){
        ...
        if (stations.size() == 0) {
            ...
            for (Station station: stations) {
                ...
                String stationString = Color.ANSI_GREEN + "-------------- Station " + station.getStationId() + " Details --------------" + Color.ANSI_RESET +
